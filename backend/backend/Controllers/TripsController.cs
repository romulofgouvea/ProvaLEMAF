    ...
    public class TripsController : ApiController
    {
        ...
        private void fakeData()
        {
            if (trips.Count == 0)
            {
                ...
                "€", 5, "2019/04/05", 1, 1, 200));

                trips.Add(new Trip(133, 3, "https://www.fuiviagens.com.br/fui-viagens/objects/images/2017-06/10202.jpg",
                "Cartagena", "Cartagena das Índias, na Colômbia, é um daqueles destinos que a gente ama visitar: cidade histórica que mescla lugares charmosos com um destino de praia incrível. E não é qualquer praia não: estamos falando de um mar do Caribe, com água cor turquesa e cristalina, formando um azul sem igual. Rodeado por areias branquinhas, a cidade possui boas opções de passeios, que variam desde conhecer praias próximas a desvendar os segredos e histórias da cidade.",
                "€", 5, "2019/04/05", 1, 2, 300));
